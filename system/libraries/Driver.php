	...
	function __get($child)
	{
		...
		if (in_array($driver_name, array_map('strtolower', $this->valid_drivers)))
		{
			...
			if ( ! class_exists($child_class))
			{
				...
				if ( ! class_exists($child_class))
				{
					log_message('error', "[ Libraries Driver ] Unable to load the requested driver: ".$child_class);
		...
		log_message('error', "[ Libraries Driver ] Invalid driver requested: ".$child_class);
