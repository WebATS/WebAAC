<?PHP
	 ...
	 */
		...
		/*
		 * -------------------------------------------------------------------
		 *  Qual email/usuário será informado ao servidor do protocolo?
		 *
	 ...
	 */	
		 ...
		 * é altamente recomendavél atualização do mesmo.
		 ...
		 * o cache do idioma do banco de dados, é recomendavel deixar em torno
		 * de 180 há 300 segundos
		 * -------------------------------------------------------------------
		 */
		 ...
		 * Os templates estão de padrão armazena na pasta "templates"
		 * -------------------------------------------------------------------
		 */
